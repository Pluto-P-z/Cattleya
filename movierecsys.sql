...
Source Database       : movierecsys

Target Server Type    : MYSQL
Target Server Version : 50717
File Encoding         : 65001

Date: 2022-09-09 22:14:55
*/
...
-- Records of sys_file
-- ----------------------------
INSERT INTO `sys_file` VALUES ('1', 'Eimy.jpg', 'jpg', '17', 'http://localhost:9090/file/6fe3a36c962c441890dbe0a64d90bebd.jpg', '82a2f5b531eebb47777d6d0d60cf33d3', '0', '1');
INSERT INTO `sys_file` VALUES ('2', 'Eimy.jpg', 'jpg', '17', 'http://localhost:9090/file/6fe3a36c962c441890dbe0a64d90bebd.jpg', '82a2f5b531eebb47777d6d0d60cf33d3', '0', '1');
...
INSERT INTO `sys_menu` VALUES ('31', '电影管理', '/movie', 'el-icon-suitcase-1', null, null, 'Movie', '305');
INSERT INTO `sys_menu` VALUES ('33', '评分管理', '/score', 'el-icon-menu', null, null, 'Score', '308');
INSERT INTO `sys_menu` VALUES ('35', '解释管理', '/explain', 'el-icon-menu', null, null, 'Explain', '999');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'pluto', 'admin', 'pluto', 'admin@qq.com', '18028823808', '广东深圳', '2022-06-01 21:10:27', 'http://localhost:9090/file/6fe3a36c962c441890dbe0a64d90bebd.jpg', 'ROLE_ADMIN');
INSERT INTO `sys_user` VALUES ('2', '犬儒比', '123', '犬儒大小姐', 'qr@qq.com', '123', '深圳', '2022-06-01 22:10:14', null, 'ROLE_USER');
INSERT INTO `sys_user` VALUES ('3', 'albacore', '123', '青花鱼大可爱', 'albacore@qq.com', '123', '深圳', '2022-06-01 22:10:18', 'http://localhost:9090/file/7737484487db47ab89e58504ddf86ac1.jpg', 'ROLE_USER');
INSERT INTO `sys_user` VALUES ('5', '123', '123', '123', null, null, null, '2022-06-05 20:21:48', null, 'ROLE_USER');
...
CREATE TABLE `t_explain` (
  ...
  `score` varchar(255) DEFAULT NULL COMMENT '预测得分',
  `exp` varchar(2000) DEFAULT NULL COMMENT '推荐解释',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `t_explain` VALUES ('10', '1', '1', '1', '1');
...
CREATE TABLE `t_movie` (
  ...
  `score` double(11,2) DEFAULT NULL COMMENT '平均评分',
  ...
  `genre` varchar(255) DEFAULT NULL COMMENT '电影类型',
  `description` varchar(2000) DEFAULT NULL COMMENT '电影描述',
  `img` varchar(255) DEFAULT '' COMMENT '电影封面',
  PRIMARY KEY (`id`)
...
-- Records of t_movie
-- ----------------------------
INSERT INTO `t_movie` VALUES ('1', '1', '1.00', '1', '1', '1', '1', '1', '1', 'http://localhost:9090/file/6fe3a36c962c441890dbe0a64d90bebd.jpg');
INSERT INTO `t_movie` VALUES ('2', '2', '2.00', '2', '2', '2', '2', '2', '2', '');
...
CREATE TABLE `t_score` (
  ...
  `mid` int(11) DEFAULT NULL COMMENT '电影id',
  `score` double(4,1) DEFAULT NULL COMMENT '用户评分',
  PRIMARY KEY (`id`)
...
-- Records of t_score
-- ----------------------------
INSERT INTO `t_score` VALUES ('1', '1', '1', '1.0');
INSERT INTO `t_score` VALUES ('2', '2', '1', '1.0');
INSERT INTO `t_score` VALUES ('3', '2', '1', '2.0');
INSERT INTO `t_score` VALUES ('4', '2', '1', '1.0');
INSERT INTO `t_score` VALUES ('5', '2', '3', '2.0');
INSERT INTO `t_score` VALUES ('6', '2', '3', '2.0');
INSERT INTO `t_score` VALUES ('7', '2', '3', null);
INSERT INTO `t_score` VALUES ('8', '2', '1', '1.0');
INSERT INTO `t_score` VALUES ('9', '2', '1', '1.0');
INSERT INTO `t_score` VALUES ('10', '2', '1', '2.0');
INSERT INTO `t_score` VALUES ('11', '2', '1', '1.0');
INSERT INTO `t_score` VALUES ('12', '2', '1', '1.0');
INSERT INTO `t_score` VALUES ('13', '2', '1', '3.0');
INSERT INTO `t_score` VALUES ('14', '2', '1', null);
INSERT INTO `t_score` VALUES ('15', '2', '1', null);
INSERT INTO `t_score` VALUES ('16', '2', '1', null);
INSERT INTO `t_score` VALUES ('17', '2', null, null);
INSERT INTO `t_score` VALUES ('18', '2', '1', '1.0');
INSERT INTO `t_score` VALUES ('19', '2', null, '1.0');
INSERT INTO `t_score` VALUES ('20', '2', null, null);
INSERT INTO `t_score` VALUES ('21', '2', '1', '5.1');
INSERT INTO `t_score` VALUES ('22', '2', '1', null);
INSERT INTO `t_score` VALUES ('23', '2', '1', '1.1');
INSERT INTO `t_score` VALUES ('24', '3', '1', '3.5');
INSERT INTO `t_score` VALUES ('25', '3', '1', '3.5');
INSERT INTO `t_score` VALUES ('26', '3', '1', '3.6');
INSERT INTO `t_score` VALUES ('27', '3', '1', null);
INSERT INTO `t_score` VALUES ('28', '3', '1', null);
INSERT INTO `t_score` VALUES ('29', '3', '1', null);
INSERT INTO `t_score` VALUES ('30', '3', '1', null);
INSERT INTO `t_score` VALUES ('31', '3', '1', '1.0');
INSERT INTO `t_score` VALUES ('32', '3', null, '1.0');
INSERT INTO `t_score` VALUES ('33', '3', '1', '2.0');
INSERT INTO `t_score` VALUES ('34', '3', '1', null);
INSERT INTO `t_score` VALUES ('35', '3', '1', null);
INSERT INTO `t_score` VALUES ('36', '3', '1', null);
INSERT INTO `t_score` VALUES ('37', '3', '1', null);
INSERT INTO `t_score` VALUES ('38', '3', null, null);
INSERT INTO `t_score` VALUES ('39', '3', null, null);
INSERT INTO `t_score` VALUES ('40', '2', '1', '5.0');
INSERT INTO `t_score` VALUES ('41', '2', '1', '3.0');
INSERT INTO `t_score` VALUES ('42', '2', '1', '5.0');
INSERT INTO `t_score` VALUES ('43', '2', '1', '5.0');
INSERT INTO `t_score` VALUES ('44', '2', '1', '3.0');
