...
public class CodeGenerator {
    ...
    // 数据库名称
    private static final String DATASOURCE = "movierecsys";
    
    // 你自己的项目路径，一定要改成你自己的！！结尾必须是:  \\springboot\\
    private static final String basePath = "F:\\大数据求职资料\\小白做毕设\\springboot\\";

    // 数据库需要生成代码的表名
    private static final String tableName = "t_explain";
    // 生成页面的菜单名称
    private static final String modelName = "解释管理";

    // ----------------------------------------以上必修修改-----------------------------------------

    // 数据库密码 （填你自己的密码，默认 123456）
    private static final String PASSWORD = "zym011016";
