...
public class MovieController {
    ...
    public Result save(@RequestBody Movie movie) {
        if (movie.getId() == null) {
            //movie.setTime(DateUtil.now());
            //movie.setUser(TokenUtils.getCurrentUser().getUsername());
        }
...
//        }
        return Result.success(movieService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Movie信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Movie> list = reader.readAll(Movie.class);

        movieService.saveBatch(list);
        return Result.success();
    }
