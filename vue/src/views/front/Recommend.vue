...
<!--            </el-popconfirm>-->
<!--            &lt;!&ndash; <el-upload action="http://localhost:9090/explain/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">-->
...
<!--        </div>-->
        ...
        <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="score" label="预测得分"></el-table-column>
            <el-table-column prop="exp" label="推荐解释"></el-table-column>
...
<script>
    export default {
        ...
        methods: {
            ...
            save() {
                this.request.post("/explain", this.form).then(res => {
                    if (res.code === '200') {
            ...
            del(id) {
                this.request.delete("/explain/" + id).then(res => {
                    if (res.code === '200') {
            ...
            delBatch() {
                ...
                this.request.post("/explain/del/batch", ids).then(res => {
                    if (res.code === '200') {
            ...
            exp() {
                window.open("http://localhost:9090/explain/export")
            },
